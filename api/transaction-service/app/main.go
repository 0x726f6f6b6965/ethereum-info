...
import (
	...
	"github.com/0x726f6f6b6965/ethereum-info/transaction-service/internal/config"
	"github.com/0x726f6f6b6965/ethereum-info/transaction-service/internal/service"
...
func main() {
	...
	server := service.NewTransactionService(db, rpcClient, redisClient, zaplog)
	...
	trans.RegisterTransactionServiceServer(grpcServer, server)
